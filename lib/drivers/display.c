/***********************************************
 * display.h
 *  4 digit 7-segment display implementation
 * 
...
const static int8_t hex_digits[] = {
    0b00111111, // 0
    0b00000110, // 1
    0b01011011, // 2
    0b01001111, // 3
...
void display_int(int16_t value)
{
    ...
    int8_t is_negative = 0; // Flag to indicate if the input value is negative
...
void display_init()
{
    ...
    // sei();   Global Interrupt flag must be enabled/disabled in main.c
}
